...
| --- | --- | --- | --- |
| [Integración con API del Estado](proyectos/sifen-facturacion-electronica) | Integración completa contra una API SOAP de un organismo del Estado paraguayo, ajustada a una especificación oficial: XML validado contra XSD, firma XMLDSig, PDF y QR, todo en PHP nativo sin dependencias. | PHP · MySQL · SOAP · XMLDSig | Funcional |
| [Automatizador de integración](proyectos/sifen-automatizador) | Versión reducida del anterior: el mismo motor sin interfaz ni base de datos, para integrar sistemas de terceros por archivos de texto. Integrado en producción con el SGP. | PHP · cron · cPanel · Docker | Funcional |
...
**Automatizador** es la reducción del sistema de integración a su motor, y el
