...
return [
    ...
    'submodulos' => [
        ...
        // Cómo está armado el salón: cómo se presenta y se ve el sistema, los
        // locales, y por dónde lo contactan.
        'configuracion' => [
            // **Ajustes es su propia clave** (7.125.0, pedido del usuario):
            // el nombre, el logo, los colores, la letra y los datos fiscales
            // vivían en Sucursales y la sobrecargaban. Son del sistema
            // entero, no de un local, así que no tienen por qué compartir
            // permiso con la lista de locales.
            'configuracion.ajustes' => 'Ajustes',
