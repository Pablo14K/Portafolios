                ...
                <div class="panel-box-inner flex-grow-1">
                    @if ($proximas)
                            ...
                            @foreach ($proximas as $c)
                                <li id="citaProxima{{ (int) $c->id_cita }}" class="flex-wrap">
                                    ...
                                    @if ($enCurso && $proxima && (int) $c->id_cita === (int) $proxima->id_cita)
                                        <a class="btn btn-sm btn-acento" href="{{ route('portal.atencion', ['id' => $c->id_cita]) }}">
                        ...
                        <div class="text-end mt-2">
                            <a class="link-acento" style="font-size:.78rem" href="{{ route('portal.citas') }}">ver todas mis citas &rarr;</a>
                        </div>
                    @else
                        ...
                        <div class="text-center pb-3">
                            <a class="btn btn-acento" href="{{ route('portal.reservar') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="metric-card h-100">
                            ...
                            <div class="metric-comparado">
                                <a class="link-acento" href="{{ route('portal.promociones') }}">qué podés canjear &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
