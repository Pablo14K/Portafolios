...
@section('contenido')
        ...
        <div class="sgp-panel mb-3">
            ...
            @foreach ($pendientes as $c)
                <form method="post" action="{{ route('portal.calificar') }}"
                      class="py-2" style="border-bottom:1px solid var(--borde)">
                    @csrf
                    ...
                    <div class="d-flex gap-2 align-items-center flex-wrap">
                        ...
                        <button class="btn btn-sm btn-acento">Enviar</button>
                    </div>
                </form>
            @endforeach
        </div>
    ...
    <div class="sgp-panel">
        ...
        @forelse ($hechas as $h)
            <div class="py-2" style="border-bottom:1px solid var(--borde)">
                <span class="txt-acento">{{ str_repeat('★', (int) $h->puntaje) . str_repeat('☆', 5 - (int) $h->puntaje) }}</span>
