...
@section('contenido')
    ...
    <div class="sgp-metrics mb-3">
        <div class="sgp-metric">
            ...
            <div class="val acento" id="mTotal">{{ money($total) }}</div>
        </div>
        @if ($sena > 0)
            <div class="sgp-metric">
    ...
    @if ($enCurso)
        <div class="sgp-panel">
            ...
            <button class="btn btn-acento" data-bs-toggle="modal" data-bs-target="#modalPedir">
                ...
                <div class="modal-content">
                    <form method="post" action="{{ route('portal.pedir') }}">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-acento">Enviar el pedido</button>
                        </div>
                    </form>
                </div>
            </div>
