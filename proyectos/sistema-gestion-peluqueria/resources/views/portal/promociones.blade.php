    ...
    @if ($fid)
        <div class="sgp-metrics mb-3">
            <div class="sgp-metric">
                ...
                <div class="val acento">{{ $fid->nivel ?: 'Bronce' }}</div>
            </div>
            <div class="sgp-metric">
    ...
    <div class="sgp-panel">
        ...
        @forelse ($promos as $p)
            <div class="d-flex justify-content-between align-items-center py-2"
                 style="border-bottom:1px solid var(--borde)">
                <div>
                ...
                <span class="txt-acento" style="font-size:1.05rem;font-weight:600">
    ...
    <div class="sgp-panel mt-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-1">
            <h2 style="font-size:1rem;font-weight:500;margin:0">
                <i class="bi bi-gift txt-acento"></i> Canjeá tus puntos
            </h2>
            <span class="txt-acento" style="font-weight:600">Tenés {{ (int) $puntos }} punto(s)</span>
        </div>
    ...
    @if ($misCanjes)
        <div class="sgp-panel mt-3">
            <h2 style="font-size:1rem;font-weight:500;margin:0 0 .5rem">
                <i class="bi bi-ticket-perforated txt-acento"></i> Lo que canjeaste
            </h2>
