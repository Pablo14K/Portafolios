{{--
    ...
    **El contenedor lo dibuja este partial, no la vista.** Es lo que hace
    ...
    cargado el fondo de color —que es el del ÍCONO por defecto— se saca, porque
    si no un logo rectangular queda con dos bandas de color a los costados y se
    ve el ícono de antes asomando de fondo. Se reportó así.

    Sin logo cargado va la tijera sobre el verde agua, que es la identidad por defecto
