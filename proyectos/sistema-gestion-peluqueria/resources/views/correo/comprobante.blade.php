...
<body style="margin:0;padding:0;background:#F2FBF9;font-family:Segoe UI,Arial,sans-serif;color:#0F4C43">
    <div style="max-width:560px;margin:24px auto;background:#FFFFFF;border-radius:12px;overflow:hidden;
        ...
        <div style="background:#0F4C43;padding:18px 24px">
            <span style="color:#7AC3B7;font-size:1.05rem;font-weight:bold">{{ $salon }}</span>
        </div>
        ...
        <div style="padding:24px">
            ...
            <table style="width:100%;border-collapse:collapse;font-size:14px">
                <thead>
                    <tr>
                        <th style="text-align:left;padding:6px 0;border-bottom:1px solid #CEEAE5;
                                   color:#375B59;font-weight:500">Detalle</th>
                        <th style="text-align:right;padding:6px 0;border-bottom:1px solid #CEEAE5;
                                   color:#375B59;font-weight:500">Cant.</th>
                        <th style="text-align:right;padding:6px 0;border-bottom:1px solid #CEEAE5;
                                   color:#375B59;font-weight:500">Importe</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($items as $it)
                        <tr>
                            <td style="padding:6px 0;border-bottom:1px solid #E1FAF5">{{ $it->item }}</td>
                            <td style="padding:6px 0;border-bottom:1px solid #E1FAF5;text-align:right">
                                {{ cant($it->cantidad) }}</td>
                            <td style="padding:6px 0;border-bottom:1px solid #E1FAF5;text-align:right">
            ...
            <table style="width:100%;border-collapse:collapse;font-size:14px;margin-top:12px">
                ...
                <tr>
                    ...
                    <td style="padding:6px 0;text-align:right;font-weight:bold;font-size:16px;color:#1A6B5F">
