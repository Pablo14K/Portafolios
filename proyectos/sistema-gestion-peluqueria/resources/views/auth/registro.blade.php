...
@section('formulario')
    <form class="sgp-login" method="post" action="{{ route('registro') }}">
        ...
        <button class="btn btn-acento w-100 py-2 mt-3" type="submit">Crear cuenta</button>

        <p class="text-center mt-3 mb-0" style="font-size:.85rem;color:var(--texto-tenue)">
            ¿Ya tenés cuenta? <a class="link-acento" href="{{ route('login') }}">Ingresá</a>
        </p>
    </form>
@endsection
