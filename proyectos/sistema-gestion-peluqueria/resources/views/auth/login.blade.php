...
<div class="sgp-login-wrap">
    ...
    <div class="sgp-login" id="bioPanel" style="display:none;text-align:center">
        ...
        <button id="bioBtn" class="btn btn-acento" aria-label="Entrar con huella"
        ...
        <p class="mt-3 mb-1">
            <a href="#" id="usarClave" class="link-acento" style="font-size:.85rem">Usar contraseña</a>
        </p>
        <p class="mb-0">
    ...
    <form class="sgp-login" id="formLogin" method="post" action="{{ route('login') }}">
        ...
        <button class="btn btn-acento w-100 py-2" type="submit">Ingresar</button>

        <p class="text-center mt-3 mb-1" style="font-size:.85rem;">
            @if (Route::has('recuperar'))
                <a class="link-acento" href="{{ route('recuperar') }}">¿Olvidaste tu contraseña?</a>
            @endif
        </p>
        <p class="text-center mb-0" style="font-size:.85rem;color:var(--texto-tenue)">
            @if (Route::has('registro'))
                ¿Sos cliente nuevo? <a class="link-acento" href="{{ route('registro') }}">Creá tu cuenta</a>
            @endif
        </p>
    </form>
    ...
    <div class="sgp-login mt-3" id="bioSuelto" style="display:none;text-align:center">
        ...
        <button id="bioBtnSuelto" class="btn btn-acento" type="button" aria-label="Entrar con huella"
