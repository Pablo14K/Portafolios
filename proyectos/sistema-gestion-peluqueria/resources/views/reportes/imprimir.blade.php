    ...
    @else
        <style>
            ...
            * { box-sizing: border-box; }
            body { margin: 0; color: #0F4C43; font-family: DejaVu Sans, sans-serif; font-size: 9px; }
            .container { width: 100%; max-width: none; padding: 0; }
            .d-flex { display: flex; }
            .justify-content-between { justify-content: space-between; }
            .align-items-start { align-items: flex-start; }
            .text-end { text-align: right; }
            .text-muted-warm { color: #375B59; }
            .table { width: 100%; border-collapse: collapse; margin: 5px 0 13px; }
            .table th { background: #E1FAF5; color: #0F4C43; font-weight: bold; }
            .table th, .table td { border: 0.5px solid #B6DFD8; padding: 4px 5px; }
            .table-sm th, .table-sm td { padding: 3px 4px; }
            h1, h2 { color: #0F4C43; }
            hr { border: 0; border-top: 1px solid #B6DFD8; margin: 8px 0; }
...
<div class="container py-3" style="max-width:900px">
    ...
    <div class="no-imprimir mb-3 d-flex gap-2">
        <button class="btn btn-acento" type="button" onclick="window.print(); return false;">
