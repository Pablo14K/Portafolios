...
<div class="d-flex justify-content-between align-items-end flex-wrap gap-2 mb-3">
    @if (count($sucursales) > 1)
        <form method="get" class="d-flex gap-2 align-items-end flex-wrap">
            ...
            <noscript><button class="btn btn-sm btn-acento">Ver</button></noscript>
        </form>
    @else
        <div></div>
    @endif
    <button type="button" class="btn btn-acento" data-bs-toggle="modal" data-bs-target="#modalCuentaNueva">
        ...
        <div class="col-12 col-md-6 col-xl-4">
            <div class="sgp-panel h-100 d-flex flex-column {{ $c->activo ? '' : 'opacity-75' }}">
                ...
                <div class="mt-3">
                    ...
                    @else
                        <div class="val acento" style="font-size:1.35rem">{{ money($c->saldo) }}</div>
                        <div class="text-muted-warm" style="font-size:.78rem">
                ...
                <div class="d-flex gap-2 flex-wrap mt-3 pt-3 border-top">
                    ...
                    @endif
                    @if ($c->activo)
                        <button type="button" class="btn btn-sm {{ $c->saldo === null ? 'btn-acento' : 'btn-outline-neutro' }}"
