...
@if ($de === 'cajas')
                        ...
                        @foreach ($abiertas as $ab)
                            <tr>
                                ...
                                <td class="text-end sgp-movil-acciones">
                                    <button type="button" class="btn btn-sm btn-acento" data-bs-toggle="modal"
    ...
    <div class="sgp-metrics sgp-metrics-compacto mb-3">
        ...
        <div class="sgp-metric">
            ...
            <div class="val {{ abs($difTotal) < 0.01 ? '' : ($difTotal < 0 ? 'txt-no' : 'txt-acento') }}">
                {{ money($difTotal) }}</div>
    ...
    <div class="sgp-panel mb-3">
                    ...
                    <tbody>
                        @foreach ($cuentas as $ct)
                            <tr>
                                ...
                                <td class="text-end sgp-movil-acciones">
                                    <button type="button" class="btn btn-sm {{ $ct->saldo === null ? 'btn-acento' : 'btn-outline-neutro' }}"
        ...
        @else
            <p class="text-muted-warm mb-0" style="font-size:.88rem">
                ...
                <a class="link-acento" href="{{ route('facturacion.cuentas') }}">Cargar una &rarr;</a>
            </p>
        @endif
    </div>
