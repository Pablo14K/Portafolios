                                    ...
                                    <td class="text-end" data-label="A pagar">
                                        @if ((int) $p->pendientes)
                                            ...
                                            @if ((float) $p->a_pagar > 0)
                                                <strong class="txt-acento">{{ money($p->a_pagar) }}</strong>
                                            @else
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            @if ($sgpL->nro)
                                                                                ...
                                                                                <a class="link-acento" href="{{ route('facturacion.factura_ver', ['id' => $sgpL->id_factura]) }}">
                                                                                    {{ $sgpL->nro }}</a>
                ...
                <div class="modal-content">
                    <form method="post" action="{{ route('facturacion.revertir_pago_personal') }}">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-acento">Revertir</button>
                        </div>
                    </form>
                </div>
            </div>
