...
@section('contenido')
    ...
    <div class="d-flex gap-2 mb-3 no-imprimir flex-wrap">
        <button class="btn btn-acento" onclick="window.print()"><i class="bi bi-printer"></i> Imprimir</button>
    ...
    <div class="sgp-panel sgp-comprobante">
        ...
        <div class="row">
            ...
            <div class="col-md-5 text-md-end">
                ...
                <div style="font-size:1.15rem;font-weight:600" class="txt-acento">{{ $f->nro_comprobante }}</div>
            ...
            <div class="col-md-5">
                <table class="table table-sm mb-0" style="font-size:.88rem">
                    ...
                    <tr>
                        ...
                        <td class="text-end"><strong class="txt-acento">{{ money($f->total) }}</strong></td>
                    </tr>
                    @if ($imp)
        ...
        <div class="sgp-panel mt-3 no-imprimir">
            ...
            @foreach ($notas as $n)
                <div class="d-flex justify-content-between align-items-center py-1">
                    <div>
                        <a class="link-acento" href="{{ route('facturacion.factura_ver', ['id' => $n->id_factura]) }}">
                            {{ $n->nro }}</a>
                ...
                <div class="modal-content">
                    <form method="post" action="{{ route('facturacion.comprobante.enviar') }}">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-acento"><i class="bi bi-send"></i> Enviar</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="post" action="{{ route('facturacion.nota_credito') }}">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline-neutro" data-bs-dismiss="modal">Cancelar</button>
                                <button class="btn btn-acento">Emitir nota de crédito</button>
                            </div>
                        </form>
                    </div>
                </div>
