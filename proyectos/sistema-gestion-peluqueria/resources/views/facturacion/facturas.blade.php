                        ...
                        <tr>
                            ...
                            <td class="text-end sgp-movil-acciones" style="white-space:nowrap">
                                ...
                                @if ((float) $r->saldo > 0.01 && $r->estado !== 'Anulada' && $caja && (int) $r->signo === 1)
                                    <button class="btn btn-sm btn-acento" title="Cobrar"
                ...
                <div class="modal-content">
                    <form method="post" action="{{ route('facturacion.cobrar') }}">
                        ...
                        <div class="modal-body">
                            <p class="mb-3">
                                Saldo pendiente: <strong class="txt-acento">{{ money($r->saldo) }}</strong>
                            </p>
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-acento">Registrar cobro</button>
                        </div>
                    </form>
                </div>
            </div>
