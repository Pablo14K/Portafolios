...
@if ($puedeCrear)
    <div class="d-flex justify-content-end mb-3">
        <button type="button" class="btn btn-acento" data-bs-toggle="modal" data-bs-target="#modalCajaNueva">
        ...
        <div class="col-12 col-md-6 col-xl-4">
            <div class="sgp-panel h-100 d-flex flex-column">
                ...
                <div class="d-flex gap-2 flex-wrap mt-3 pt-3 border-top">
                    ...
                    @elseif (! $c->id_caja)
                        <button type="button" class="btn btn-sm btn-acento"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('facturacion.caja_fisica.guardar') }}">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-neutro" data-bs-dismiss="modal">Cancelar</button>
                        <button class="btn btn-acento"><i class="bi bi-check2"></i> Crear</button>
                    </div>
                </form>
            </div>
        </div>
