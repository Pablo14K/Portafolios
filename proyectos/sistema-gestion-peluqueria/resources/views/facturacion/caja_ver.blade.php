    ...
    <div class="sgp-panel mb-3">
        <div class="sgp-metrics sgp-metrics-compacto">
            <div class="sgp-metric">
                ...
                <div class="val acento">{{ money($saldo) }}</div>
        ...
        <div class="d-flex gap-2 flex-wrap mt-3">
            ...
            <button class="btn btn-acento" data-bs-toggle="modal" data-bs-target="#modalArqueo">
...
@else
    ...
    <div class="sgp-panel">
        ...
        <form method="post" action="{{ route('facturacion.caja.abrir') }}"
            ...
            <button class="btn btn-acento"><i class="bi bi-unlock"></i> Abrir caja</button>
        </form>
    </div>
@endif
@endsection
