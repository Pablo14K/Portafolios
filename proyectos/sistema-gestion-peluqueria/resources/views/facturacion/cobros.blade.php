...
@section('contenido')
    <x-encabezado :sub="'Total ' . ($f['activos'] ? 'de lo filtrado' : 'general')
                        . ': <strong class=\'txt-acento\'>' . money($totalFiltrado) . '</strong> (sin contar los anulados)'" />
    ...
    @if (! empty($porCobrar))
        <div class="sgp-panel mb-3" style="border-left:3px solid var(--acento)">
                            ...
                            <tr id="porCobrar{{ (int) $pc->id_cita }}">
                                ...
                                <td class="text-end sgp-movil-acciones">
                                    ...
                                    @if ((float) $pc->saldo_fact > 0.5)
                                        <a class="btn btn-sm btn-acento" title="Ya tiene comprobante: se cobra contra él, en Facturas"
                                           href="{{ route('facturacion.facturas', ['q' => $pc->cliente, 'saldo' => 'pend']) }}">
                                            <i class="bi bi-cash-coin"></i> Cobrar</a>
                                    @else
                                        <a class="btn btn-sm btn-acento" title="Abre la ventana de cobro de esta cita"
                                        ...
                                        <div class="sgp-det-grid">
                                            ...
                                            <div>
                                                ...
                                                <dd>
                                                    ...
                                                    @if ($r->id_factura)
                                                        <a class="link-acento" href="{{ route('facturacion.factura_ver', ['id' => $r->id_factura]) }}"
                ...
                <div class="modal-content">
                    <form method="post" action="{{ route('facturacion.cobro.anular') }}">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-acento">Anular el cobro</button>
                        </div>
                    </form>
                </div>
            </div>
