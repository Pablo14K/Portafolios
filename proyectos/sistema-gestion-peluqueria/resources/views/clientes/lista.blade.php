                        ...
                        <tr>
                            ...
                            <td class="sgp-movil-titulo sgp-movil-sujeto" data-label="Cliente">
                                <span class="sgp-celda-persona">
                                    ...
                                    <a class="link-acento" href="{{ route('clientes.historial', $c->id_cliente) }}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-size:1rem">
                        <i class="bi bi-person-vcard txt-acento"></i>
                        {{ $c->nombre }} {{ $c->apellido }}
                    </h5>
                ...
                <div class="modal-footer">
                    ...
                    @endif
                    <a class="btn btn-acento btn-sm" href="{{ route('clientes.form', $c->id_cliente) }}">
