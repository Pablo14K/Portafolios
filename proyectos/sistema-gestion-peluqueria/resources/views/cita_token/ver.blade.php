...
<div class="container py-4" style="max-width:620px">
    ...
    @if (! $cita)
        <div class="sgp-panel text-center">
            <div style="font-size:2rem;color:var(--acento)"><i class="bi bi-link-45deg"></i></div>
    ...
    @else
        <div class="sgp-panel mb-3">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <a class="btn btn-sm btn-acento" download
        ...
        <div class="sgp-panel mb-3">
            ...
            <form method="post" action="{{ route('cita.token.guardar') }}">
                ...
                {{-- **Seguís con tu profesional.** El combo ofrecía cambiarlo, y
                     ...
                     desplegable. --}}
                <button class="btn btn-acento w-100" id="btnReprog" disabled>Reprogramar mi cita</button>
            </form>
        </div>
        @endif
