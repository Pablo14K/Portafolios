...
class SeguridadController extends Controller
{
    ...
    public function personal(): View
    {
        return view('seguridad.personal', [
            'subs' => Permisos::tarjetasPermitidas([
                // **Su propia pantalla desde la 7.68.0.** Antes abría la
                // ficha de Usuarios con `?desde=personal`, así que para
                // cargar a alguien que atiende había que inventarle una
                // cuenta de sistema — y hay gente que no entra nunca.
                ['p' => 'personal.profesionales', 'ruta' => 'seguridad.profesionales', 'ic' => 'people',
                 't' => 'Profesionales', 'd' => 'El equipo del salón y sus datos'],
     ...
     *
     * Lo que es del negocio y no de la operación: cómo se presenta y se ve el
     * sistema, los locales y por dónde lo contactan. Es lo que se toca una vez
     * y no se vuelve a mirar, así que no tiene por qué competir con la agenda.
     */
        ...
        return view('seguridad.configuracion', [
            ...
            'subs' => array_merge(
                Permisos::tarjetasPermitidas([
                    // **Ajustes va primero**: es lo del sistema entero. Salió
                    // de Sucursales en la 7.125.0, que lo cargaba encima de la
                    // lista de locales.
                    ['p' => 'configuracion.ajustes', 'ruta' => 'seguridad.ajustes', 'ic' => 'gear',
                     't' => 'Ajustes', 'd' => 'Identidad, apariencia, texto y datos fiscales'],
                    ['p' => 'configuracion.sucursales', 'ruta' => 'seguridad.sucursales', 'ic' => 'shop',
                     't' => 'Sucursales', 'd' => 'Los locales del salón'],
