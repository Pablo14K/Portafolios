    ...
    private function xls(string $nombre, string $seccion, array $hojas, array $datos): StreamedResponse
    {
        ...
        return response()->streamDownload(function () use ($titulo, $hojas, $filtros) {
            ...
            echo '<style>
                ...
                th{background:#0F4C43;color:#FFFFFF;font-weight:bold;text-align:left;
                   border:1px solid #1A6B5F;padding:6px 8px;white-space:nowrap}
                td{border:1px solid #CEEAE5;padding:4px 8px;vertical-align:top}
                td.n{text-align:right;mso-number-format:"#,##0.00"}
                td.c{text-align:right;mso-number-format:"[$₲-es-PY] #,##0.00"}
                .t{font-size:15pt;font-weight:bold;color:#1A6B5F;padding:4px 0}
                .s{font-size:10pt;color:#375B59;padding:2px 0}
                ...
                .grafico-leyenda{font-size:9pt;color:#375B59;margin-top:3px;text-align:left}
            </style></head><body>';
