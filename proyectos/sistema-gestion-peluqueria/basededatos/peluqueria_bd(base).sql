...
CREATE TABLE `caja` (
  ...
  `id_caja_fisica` int(10) unsigned NOT NULL,
  ...
  KEY `fk_caja_fisica` (`id_caja_fisica`),
  ...
  CONSTRAINT `fk_caja_fisica` FOREIGN KEY (`id_caja_fisica`) REFERENCES `caja_fisica` (`id_caja_fisica`),
  ...
  IF NEW.id_estado_caja = 1
     AND EXISTS (SELECT 1 FROM caja
                  WHERE id_estado_caja = 1
                    AND id_caja_fisica = NEW.id_caja_fisica) THEN
    SELECT nombre INTO v_nombre FROM caja_fisica WHERE id_caja_fisica = NEW.id_caja_fisica;
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'Esa caja ya está abierta. Cerrala antes de volver a abrirla.';
  END IF;
END */;;
DELIMITER ;
...
--
-- Table structure for table `caja_fisica`
--
...
--
-- Dumping data for table `caja_fisica`
--
...
INSERT INTO `comision` VALUES (12,18,NULL,NULL,'PORCENTAJE',15.00,'2026-08-22',1),(13,16,NULL,NULL,'PORCENTAJE',15.00,'2026-08-22',1),(14,17,NULL,NULL,'PORCENTAJE',15.00,'2026-08-22',1),(15,19,NULL,NULL,'PORCENTAJE',15.00,'2026-08-22',1);
...
--
-- Table structure for table `compra_nota_credito`
--

DROP TABLE IF EXISTS `compra_nota_credito`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `compra_nota_credito` (
  ...
  CONSTRAINT `chk_cnc_anulacion` CHECK (`activo` = 1 and `anulado_motivo` is null or `activo` = 0 and `anulado_motivo` is not null)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `compra_nota_credito`
--

LOCK TABLES `compra_nota_credito` WRITE;
/*!40000 ALTER TABLE `compra_nota_credito` DISABLE KEYS */;
/*!40000 ALTER TABLE `compra_nota_credito` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `configuracion` (
  ...
  `tema_colores` longtext DEFAULT NULL,
...
INSERT INTO `configuracion` VALUES (1,'Peluquería Luque',NULL,'96021','PELUQUERIA Y OTROS TRATAMIENTOS DE BELLEZA',NULL,NULL,NULL,NULL,NULL,10000);
...
CREATE TABLE `detalle_compra` (
  ...
  CONSTRAINT `chk_dc_iva` CHECK (`tasa_iva` in (0,5,10))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `producto` VALUES (11,2,'Shampoo profesional 1L','Para lavado en el salón','unidad',85000.00,130000.00,10,1,1000.00,'ml'),(12,2,'Acondicionador 1L','Para lavado en el salón','unidad',80000.00,125000.00,10,1,1000.00,'ml'),(13,1,'Agua oxigenada 900ml','Revelador 20 volúmenes','unidad',35000.00,55000.00,10,1,900.00,'ml'),(14,1,'Tintura profesional','Tubo de 60 g, varios tonos','unidad',45000.00,70000.00,10,1,NULL,NULL),(15,2,'Ampolla de keratina','Sachet individual','unidad',18000.00,32000.00,10,1,NULL,NULL),(16,2,'Serum reparador 100ml','Puntas abiertas','unidad',40000.00,68000.00,10,1,NULL,NULL),(17,3,'Guantes de latex (caja)','Caja por 100 unidades','caja',38000.00,60000.00,10,1,NULL,NULL),(18,3,'Toallas descartables','Paquete por 50','paquete',25000.00,40000.00,10,1,NULL,NULL),(19,4,'Esmalte semipermanente','Frasco de 15 ml','unidad',22000.00,38000.00,10,1,NULL,NULL),(20,5,'Shampoo x 300ml (venta)','Para llevar','unidad',45000.00,85000.00,10,1,NULL,NULL);
...
INSERT INTO `producto_sucursal` VALUES (11,1,3.00,1),(12,1,3.00,1),(13,1,4.00,1),(14,1,6.00,1),(15,1,10.00,1),(16,1,5.00,1),(17,1,2.00,1),(18,1,3.00,1),(19,1,8.00,1),(20,1,5.00,1);
...
INSERT INTO `proveedor` VALUES (7,'Marisa Duarte',1,19),(8,'Jorge Cabrera',1,20),(9,'Liliana Ayala',1,21);
...
INSERT INTO `servicio_canjeable` VALUES (5,21,400,30,1),(6,24,150,30,1);
...
INSERT INTO `servicio_sucursal` VALUES (16,1),(17,1),(18,1),(19,1),(20,1),(21,1),(22,1),(23,1),(24,1),(25,1),(26,1),(27,1),(28,1),(29,1),(30,1);
...
INSERT INTO `timbrado` VALUES (7,1,1,'12345678','001','001','2026-08-22','2027-08-22',1,9999999,1),(8,1,5,'12345679','001','001','2026-08-22','2027-08-22',1,9999999,1),(9,1,8,'12345680','001','999','2026-08-22','2027-08-22',1,9999999,1);
...
INSERT INTO `tipo_comprobante` VALUES (1,'01','Factura',1,0,1),(2,'02','Boleta de venta',1,0,0),(3,'03','Ticket',1,0,0),(4,'04','Autofactura',1,0,0),(5,'05','Nota de credito',-1,1,1),(6,'06','Nota de debito',1,1,0),(7,'07','Nota de remision',0,0,0),(8,'08','Comprobante de pago',1,0,0);
...
INSERT INTO `tipo_movimiento_caja` VALUES (1,'Gasto con comprobante','S',1,1),(2,'Retiro de la propietaria','S',1,1),(5,'Faltante de caja','S',0,1),(6,'Devolución al cliente','S',0,1);
...
INSERT INTO `turno_dia` VALUES (15,1),(15,2),(15,3),(15,4),(15,5),(15,6),(16,1),(16,2),(16,3),(16,4),(16,5),(16,6);
...
INSERT INTO `usuario` VALUES (1,1,1,'admin','$2y$10$aXqyrTtSHIcE7N.sPEA6xuI64h/JOM0/5frSbU5CuVp3qlQypgxgW','2026-07-14',1,'2026-07-14 19:42:29',1,'ecb6186932b3230ba0a140bdb4e2570e','2026-08-21 13:25:48'),(2,4,NULL,'cliente','$2y$12$n09uK0KMVcfnmh.CZPd8dO7vEHibV04W.H.cOT7niBCffCLgKvaEu',NULL,1,'2026-07-14 19:42:29',2,NULL,NULL),(16,2,1,'marta','$2y$12$Tl6dYeN6n5TYvdP/RZH6v.oll4BX3dAjKYnrewjAQ0fz7pWwT2jY6',NULL,1,'2026-08-22 20:32:58',22,NULL,NULL),(17,2,1,'rocio','$2y$12$Tl6dYeN6n5TYvdP/RZH6v.oll4BX3dAjKYnrewjAQ0fz7pWwT2jY6',NULL,1,'2026-08-22 20:32:58',23,NULL,NULL),(18,2,1,'lucia','$2y$12$Tl6dYeN6n5TYvdP/RZH6v.oll4BX3dAjKYnrewjAQ0fz7pWwT2jY6',NULL,1,'2026-08-22 20:32:58',24,NULL,NULL),(19,2,1,'sofia','$2y$12$Tl6dYeN6n5TYvdP/RZH6v.oll4BX3dAjKYnrewjAQ0fz7pWwT2jY6',NULL,1,'2026-08-22 20:32:58',25,NULL,NULL);
...
INSERT INTO `usuario_turno` VALUES (16,15),(17,16),(18,15),(19,16);
...
--
-- Temporary table structure for view `vw_compra_impuestos`
--

DROP TABLE IF EXISTS `vw_compra_impuestos`;
/*!50001 DROP VIEW IF EXISTS `vw_compra_impuestos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vw_compra_impuestos` AS SELECT
 1 AS `id_compra`,
  1 AS `gravado_10`,
  1 AS `iva_10`,
  1 AS `gravado_5`,
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_compra_acreditado` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_compra_acreditado`(p_id_compra INT UNSIGNED) RETURNS decimal(14,2)
    READS SQL DATA
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_compra_bruto` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_compra_bruto`(p_id_compra INT UNSIGNED) RETURNS decimal(14,2)
    READS SQL DATA
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_compra_cuota_falta` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_compra_cuota_falta`(p_id_compra INT UNSIGNED) RETURNS decimal(14,2)
    READS SQL DATA
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_compra_cuota_pendiente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_compra_cuota_pendiente`(p_id_compra INT UNSIGNED) RETURNS smallint(5) unsigned
    READS SQL DATA
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_compra_pagado` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_compra_pagado`(p_id_compra INT UNSIGNED) RETURNS decimal(14,2)
    READS SQL DATA
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_abrir_caja`(
  ...
  IN  p_id_caja_fisica INT UNSIGNED,
...
BEGIN
  ...
  SELECT id_sucursal INTO v_sucursal
    FROM caja_fisica WHERE id_caja_fisica = p_id_caja_fisica AND activo = 1;

  IF v_sucursal IS NULL THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Esa caja no existe o está dada de baja.';
  END IF;

  INSERT INTO caja (id_usuario, id_sucursal, id_caja_fisica, id_estado_caja,
                    fecha_apertura, monto_inicial, observacion_apertura)
  VALUES (p_id_usuario, v_sucursal, p_id_caja_fisica, 1, NOW(), p_monto,
...
--
-- Final view structure for view `vw_compra_impuestos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_compra_impuestos` AS select `c`.`id_compra` AS `id_compra`,round(sum(case when `dc`.`tasa_iva` = 10 then round(`dc`.`cantidad` * `dc`.`precio_unitario`,2) else 0 end) * if(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) > 0,(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) - `c`.`descuento`) / sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)),1),2) AS `gravado_10`,round(sum(case when `dc`.`tasa_iva` = 10 then round(`dc`.`cantidad` * `dc`.`precio_unitario`,2) else 0 end) * if(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) > 0,(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) - `c`.`descuento`) / sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)),1) / 11,2) AS `iva_10`,round(sum(case when `dc`.`tasa_iva` = 5 then round(`dc`.`cantidad` * `dc`.`precio_unitario`,2) else 0 end) * if(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) > 0,(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) - `c`.`descuento`) / sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)),1),2) AS `gravado_5`,round(sum(case when `dc`.`tasa_iva` = 5 then round(`dc`.`cantidad` * `dc`.`precio_unitario`,2) else 0 end) * if(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) > 0,(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) - `c`.`descuento`) / sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)),1) / 21,2) AS `iva_5`,round(sum(case when `dc`.`tasa_iva` = 0 then round(`dc`.`cantidad` * `dc`.`precio_unitario`,2) else 0 end) * if(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) > 0,(sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)) - `c`.`descuento`) / sum(round(`dc`.`cantidad` * `dc`.`precio_unitario`,2)),1),2) AS `exentas`,`fn_compra_total`(`c`.`id_compra`) AS `total` from (`compra` `c` join `detalle_compra` `dc` on(`dc`.`id_compra` = `c`.`id_compra`)) group by `c`.`id_compra`,`c`.`descuento` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_compra_resumen` AS select `c`.`id_compra` AS `id_compra`,`c`.`fecha` AS `fecha`,`pp`.`nombre` AS `proveedor`,trim(concat_ws(' ',`pu`.`nombre`,`pu`.`apellido`)) AS `registro`,`ec`.`nombre` AS `estado`,`fn_compra_bruto`(`c`.`id_compra`) AS `bruto`,`c`.`descuento` AS `descuento`,`fn_compra_total`(`c`.`id_compra`) AS `total`,`fn_compra_acreditado`(`c`.`id_compra`) AS `acreditado`,`c`.`observaciones` AS `observaciones` from (((((`compra` `c` join `proveedor` `pr` on(`pr`.`id_proveedor` = `c`.`id_proveedor`)) join `persona` `pp` on(`pp`.`id_persona` = `pr`.`id_persona`)) join `usuario` `u` on(`u`.`id_usuario` = `c`.`id_usuario`)) join `persona` `pu` on(`pu`.`id_persona` = `u`.`id_persona`)) join `estado_compra` `ec` on(`ec`.`id_estado_compra` = `c`.`id_estado_compra`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_cuenta_proveedor` AS select `c`.`id_compra` AS `id_compra`,`p`.`id_proveedor` AS `id_proveedor`,`pp`.`nombre` AS `proveedor`,`c`.`fecha` AS `fecha`,`c`.`nro_factura_proveedor` AS `nro_factura_proveedor`,`cv`.`nombre` AS `condicion`,`cv`.`dias_credito` AS `dias_credito`,`fn_compra_vencimiento`(`c`.`id_compra`) AS `vencimiento`,`fn_compra_bruto`(`c`.`id_compra`) AS `bruto`,`c`.`descuento` AS `descuento`,`fn_compra_total`(`c`.`id_compra`) AS `total`,`fn_compra_pagado`(`c`.`id_compra`) AS `pagado`,`fn_compra_acreditado`(`c`.`id_compra`) AS `acreditado`,`fn_compra_saldo`(`c`.`id_compra`) AS `saldo`,`fn_compra_cuotas`(`c`.`id_compra`) AS `cuotas`,`fn_compra_cuota_pendiente`(`c`.`id_compra`) AS `cuota_pendiente`,`fn_compra_cuota_falta`(`c`.`id_compra`) AS `cuota_falta`,if(`fn_compra_saldo`(`c`.`id_compra`) > 0 and `fn_compra_vencimiento`(`c`.`id_compra`) < curdate(),1,0) AS `vencida` from (((`compra` `c` join `proveedor` `p` on(`p`.`id_proveedor` = `c`.`id_proveedor`)) join `persona` `pp` on(`pp`.`id_persona` = `p`.`id_persona`)) join `condicion_venta` `cv` on(`cv`.`id_condicion_venta` = `c`.`id_condicion_venta`)) where `c`.`id_estado_compra` = 2 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-09-16 17:58:01
